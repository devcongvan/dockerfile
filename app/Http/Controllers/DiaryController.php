...
use App\Repositories\Eloquents\DiaryRepository;
...
class DiaryController extends Controller
{
    ...
    public function index(Request $request)
    {
        $condition = [
            'with'    => 'candidateType',
            'wheres'   => ['d_can_id'=> $request->get('d_can_id')],
            'orderby' => ['id','desc'],
    ...
    public function destroyAjax(Request $request)
    {
        ...
        $prevItemId = $this->diaryRepository->getAll(['wheres' => [['id', '<', $id]], 'max' => 'id']);
        $nextItemId = $this->diaryRepository->getAll(['wheres' => [['id', '>', $id]], 'min' => 'id']);
