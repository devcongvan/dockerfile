    ...
    <div class="content-wrapper candidate">
        ...
        <div class="content-header candidate-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Sửa kỹ năng</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                                <a href="skill/list" class="btn btn-default btn-blue"><i class="nav-icon fa fa-list-ul" aria-hidden="true"></i> Danh sách kỹ năng</a>
                            </li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-8 candidate-sideright">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="candidateBox-row row ml-14">
                                                ...
                                                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                                    <input  type="text" name="sk_name" value="{{old('sk_name')?old('sk_name'):$skill->sk_name}}" placeholder="Laravel" class="form-group candidate-input">
                            ...
                            <!-- /.card -->
                            <button type="submit" class="btn btn-default btn-submit btn-blue"><i class="nav-icon fa fa-wrench" aria-hidden="true"></i> Sửa</button>
                        </section>
                    </div>
                    <!-- /.row (main row) -->
                </div><!-- /.container-fluid -->
