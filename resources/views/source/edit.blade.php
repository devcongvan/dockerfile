...
@section('content')
    ...
    <div class="content-wrapper candidate">
        ...
        <!-- Main content -->
        <form action="source/edit/{{$source->id}}" method="post">
            @csrf
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="candidateBox-row row ml-14">
                                                ...
                                                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                                    <input  type="text" name="so_name" value="{{old('so_name')?old('so_name'):$source->so_name}}" placeholder="123job" class="form-group candidate-input">
