...
var CandidateDiary = {
    ...
    composerEffect: function () {
        ...
        $(document).on('click','.candidate-item a[data-target="#candidate-evaluate"]',function () {
    ...
    confirm: function () {
        ...
        $(document).on('click', '.dropdown-item[data-confirm="diary"]', function (e) {
            ...
            $('.candidate-evaluate-confirm .btn-delete').off('click').click(function () {
                ...
                $this.removeAnDiaryItem(diaryId, diaryIndex,deleteUrl);
    ...
    removeAnDiaryItem: function (diaryId, diaryIndex,deleteUrl) {
        var $this = this;
    ...
    rate: function () {
        ...
        $.getJSON("json/candidate_rate.json", function (data) {
            ...
            $(document).on('mouseover', '.rateCandidate-item', function () {
                ...
                $('.rateCandidate-scrore').val(data[onStar].id);
